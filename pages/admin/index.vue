    ...
    <div class="admin-page m-15">
        ...
        <section class="new-post">
            ...
            <button @click="onLogout"
                ...
                <span
                    class="absolute flex items-center justify-center w-full h-full text-purple-500 transition-all duration-300 transform group-hover:translate-x-full ease">Logout
                    of post
                </span>
